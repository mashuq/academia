...
class VideoLesson(Lesson):
    ...
    video_type = models.CharField(choices=VideoType.choices,default=VideoType.YOUTUBE, max_length=32) 
    
class AudioLesson(Lesson):
    class AudioType(models.TextChoices):
        SOUNDCLOUD = 'SOUNDCLOUD', _('SoundCloud')
    link = models.CharField(max_length=512)
    audio_type = models.CharField(choices=AudioType.choices,default=AudioType.SOUNDCLOUD, max_length=32) 
...
class Assessment(models.Model):
    ...
    section = models.ForeignKey('Section',on_delete=models.CASCADE)
    after_session = models.ForeignKey('Session',on_delete=models.SET_NULL, null=True)
    assessment_type = models.CharField(choices=AssessmentType.choices,default=AssessmentType.QUIZ, max_length=32) 
