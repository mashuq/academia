...
urlpatterns = [
     ...
     path('save_session_section_visibility/', views.save_session_section_visibility),
     ...
     path('save_assessment_question_for_teacher/', views.save_assessment_question_for_teacher),
     path('list_assessment_question_for_teacher/', views.list_assessment_question_for_teacher),
     path('delete_assessment_question_for_teacher/', views.delete_assessment_question_for_teacher),
     path('get_student_section/', views.get_student_section),
     path('save_enrolment/', views.save_enrolment),
     path('delete_enrolment/', views.delete_enrolment),
     path('home_testimonials/', views.home_testimonials),
     path('list_sections_for_student/', views.list_sections_for_student),
     path('list_detailed_sections_for_teacher/', views.list_detailed_sections_for_teacher), 
     path('list_sections_for_teacher/', views.list_sections_for_teacher), 
     path('sessions_by_course_student/', views.sessions_by_course_student),
     path('sessions_by_course_teacher/', views.sessions_by_course_teacher),
     path('audio_lessons_by_session_student/', views.audio_lessons_by_session_student),
     path('video_lessons_by_session_student/', views.video_lessons_by_session_student),
     path('note_lessons_by_session_student/', views.note_lessons_by_session_student),
     path('link_lessons_by_session_student/', views.link_lessons_by_session_student),
     path('audio_lessons_by_session_teacher/', views.audio_lessons_by_session_teacher),
     path('video_lessons_by_session_teacher/', views.video_lessons_by_session_teacher),
     path('note_lessons_by_session_teacher/', views.note_lessons_by_session_teacher),
     path('link_lessons_by_session_teacher/', views.link_lessons_by_session_teacher), 
     path('search_student/', views.search_student),
     path('enrolled_students/', views.enrolled_students),
