  ...
  <span>
    <template v-if="showLogin">
      <v-row no-gutters>
        ...
        <v-col>
          <v-container>
            Not registered as student ? <v-btn @click="showRegistrationDialog" color="success">Register</v-btn>
          </v-container>
          <Login />
        </v-col>
        <v-col></v-col>
    ...
    <template v-if="showRegistration">
      <v-row no-gutters>
        ...
        <v-col>
          <v-container>
            Already registered as student ? <v-btn @click="hideRegistrationDialog" color="success">Login</v-btn>
          </v-container>
